...
class DuplicateAudit extends Page implements HasTable
{
    use InteractsWithTable;

    protected static string $resource = InvoiceResource::class;

    protected static ?string $title = 'Auditoría de Duplicados';
    protected static ?string $navigationLabel = 'Auditoría de Duplicados';
    protected static ?string $navigationIcon = 'heroicon-o-square-2-stack';
    protected static ?string $navigationGroup = '🕵️‍♂️ Inteligencia Forense';

    protected static string $view = 'filament.resources.invoice-resource.pages.duplicate-audit';
